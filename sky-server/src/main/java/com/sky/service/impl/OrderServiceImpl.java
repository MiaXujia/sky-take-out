...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderSubmitVO submitOrder(OrdersSubmitDTO ordersSubmitDTO) {
        ...
        orders.setAddress(String.valueOf(addressBook.getId()));
        this.orders = orders;
        ...
        OrderSubmitVO ordersSubmitVO = OrderSubmitVO.builder()
                ...
                .orderNumber(String.valueOf(orders.getOrderTime()))
...
*/
    ...
    /**
     * 支付成功，修改订单状态,这里由于我们并没有真正的支付，所以并不需要用到这个代码了
     *
     * @param outTradeNo
     */
